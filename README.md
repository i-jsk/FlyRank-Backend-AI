# FlyRank Backend AI Internship- Repository

Welcome to my official repository for the **FlyRank Backend AI Internship**! This repository contains my weekly assignments, backend services, API designs, database integrations, and AI system implementations built throughout the internship program.
...
├── Week 2 - A1 CRUD API/                  # W2 · A1 — Build Your First CRUD API (In-Memory)
...
│   └── README.md                          # Assignment 2 specific documentation
...
| **Week 3 — A2** | **Containerizing Stack** (Docker + PostgreSQL + Docker Compose) | Python 3.12, FastAPI, PostgreSQL, Docker | 🔄 In Progress (Stage 2 Complete) | [View Assignment](file:///j:/Documents/GitHub/FlyRank-Backend-AI/Week%203%20-%20A2%20Containerizing%20Stack/README.md) |
