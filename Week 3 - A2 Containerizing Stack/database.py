...
# Retrieve DATABASE_URL with a sensible default fallback for local docker postgres
DATABASE_URL = os.getenv(
    "DATABASE_URL", "postgresql://postgres:dev@localhost:5432/tasks"
)

# Normalize postgres:// to postgresql:// if needed (compatibility with various cloud/container providers)
