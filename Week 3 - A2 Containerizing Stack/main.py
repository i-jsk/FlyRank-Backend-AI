...
# Initialize PostgreSQL database schema and seed table if empty
init_db()

# Initialize FastAPI application
app = FastAPI(
    title="Task API — Containerized PostgreSQL Edition",
    description="FlyRank Backend AI Internship — Week 3 Assignment 2 (Containerized Stack + PostgreSQL).",
    version="1.0.0",
